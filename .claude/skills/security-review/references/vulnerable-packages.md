...
> Project safety note: this upstream table is historical detection guidance,
> not a live advisory database. Package versions and vulnerability status may
> have changed. Never create a finding from this table alone; require concrete
> version and advisory evidence in the supplied MR material, or state that
